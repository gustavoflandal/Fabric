...
class PCPDashboardController {
   ...
   */
  async getAllDashboardData(req: Request, res: Response, next: NextFunction) {
    try {
   ...
   */
  async getDailyProduction(req: Request, res: Response, next: NextFunction) {
    try {
   ...
   */
  async getWorkCenterEfficiency(req: Request, res: Response, next: NextFunction) {
    try {
   ...
   */
  async getWorkCenterOccupation(req: Request, res: Response, next: NextFunction) {
    try {
   ...
   */
  async getTimeDistribution(req: Request, res: Response, next: NextFunction) {
    try {
      const days = parseInt(req.query.days as string) || 7;
